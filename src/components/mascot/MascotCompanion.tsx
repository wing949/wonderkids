...
export const MascotCompanion: React.FC<MascotCompanionProps> = ({
  ...
  const mascotImages: Record<string, string> = {
    bobo: '/assets/bobo_math.webp',
    miumiu: '/assets/miumiu_story.webp',
    pipi: '/assets/pipi_english.webp',
    bipbip: '/assets/bipbip_logic.webp',
    lion: '/assets/mascots/mascot_lion.webp',
    dino: '/assets/mascots/mascot_dino.webp',
    bunny: '/assets/mascots/mascot_bunny.webp',
    bear: '/assets/mascots/mascot_bear.webp',
    cat: '/assets/mascots/mascot_cat.webp',
    puppy: '/assets/mascots/mascot_puppy.webp',
    panda: '/assets/mascots/mascot_panda.webp',
    unicorn: '/assets/mascots/mascot_unicorn.webp',
    penguin: '/assets/mascots/mascot_penguin.webp',
    koala: '/assets/mascots/mascot_koala.webp',
    tiger: '/assets/mascots/mascot_tiger.webp',
    astronaut: '/assets/mascots/mascot_astronaut.webp',
    princess: '/assets/mascots/mascot_princess.webp',
  };
