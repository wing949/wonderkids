...
g1_tap2_keys = [f"tv-g1-b{i}" for i in range(21, 31)]
print(f"🎙️ Bắt đầu thu âm 10 bài Tiếng Việt 1 Tập 2 chuẩn SGK bằng giọng Cô Giáo Vy...", flush=True)

for idx, lesson_id in enumerate(g1_tap2_keys, 1):
    item = data[lesson_id]
    ...
    print(f"[{idx}/{len(g1_tap2_keys)}] Thu âm: {lesson_id} — {title}...", flush=True)
    try:
...
print("🎉 ĐÃ HOÀN TẤT THU ÂM TOÀN BỘ 10 BÀI TIẾNG VIỆT 1 TẬP 2 MỚI!", flush=True)
